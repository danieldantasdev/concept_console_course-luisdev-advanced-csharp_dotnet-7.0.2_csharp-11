using CSharpAdvanced.Tpl.Infra;
...
internal class ExampleService
{
    ...
    public async Task AddProducts_Async_2_SomeProductsNotAdded()
    {
        ...
        foreach (var product in products)
        {
            var task = Task.Run(() =>
            {
                if (product.IsValid()) validProducts.Add(product);
            });
        ...
        foreach (var product in validProducts) await productRepository.AddProduct(product);
    }
    ...
    private static List<Product> GenerateProducts()
    {
        ...
        {
            new() { Id = Guid.NewGuid(), Name = "Bike", Price = 1000 },
            new() { Id = Guid.NewGuid(), Name = "Car", Price = 100000 },
            new() { Id = Guid.NewGuid(), Name = "Boat", Price = 200000 },
            new() { Id = Guid.NewGuid(), Name = "Jet", Price = 1000000 },
            new() { Id = Guid.NewGuid(), Name = "Computer", Price = 2000 },
            new() { Id = Guid.NewGuid(), Name = "Mouse", Price = 20 },
            new() { Id = Guid.NewGuid(), Name = "Keyboard", Price = 50 },
            new() { Id = Guid.NewGuid(), Name = "Monitor", Price = 500 },
            new() { Id = Guid.NewGuid(), Name = "Pen", Price = 2 },
            new() { Id = Guid.NewGuid(), Name = "Pencil", Price = 1 },
            new() { Id = Guid.NewGuid(), Name = "Bike", Price = 1000 },
            new() { Id = Guid.NewGuid(), Name = "Car", Price = 100000 },
            new() { Id = Guid.NewGuid(), Name = "Boat", Price = 200000 },
            new() { Id = Guid.NewGuid(), Name = "Jet", Price = 1000000 },
